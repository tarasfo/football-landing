export const dictionary = {
  en: {
    ...
    "connect-description":
      "Тримайте прямий зв'язок з вашими фанами використовуючи різні інструменти комунікації, включаючи текстові трансляції матчів, пуш-сповіщення та анкетування.",

    "manage-title": "Зручне управління контентом",
    "manage-description":
      "Використовуйте нашу мобільно-оптимізовану панель адміністрації для легкого та ефективного управління контентом прямо з вашого телефону. Керуйте розкладом матчів, новинами та інформацією про гравців та команду.",

    "show-title": "Висвітлюйте життя основної та молодіжної команд",
    "show-description":
      "Незалежно від того, скільки команд входить до вашого клубу, наш додаток надає змогу вболівати за кожну команду. Всі ваші команди можуть бути включені в один додаток.",

    "events-title": "Події в реальному часі",
    "events-description":
      "Отримуйте найсвіжішу інформацію прямо тоді, коли вона стає доступною. Розклади матчів, огляди матчів, прямі трансляції та детальний аналіз подій - все це відбувається в реальному часі.",

    "agree-title": "Дізнайтесь думку фанів",
    "agree-description":
      "Збирайте відгуки і відповіді ваших фанів, використовуючи анкети, опитування та голосування. Навчайтесь та реагуйте на побажання своєї аудиторії, щоб підвищити її задоволеність та взаємодію.",

    "football-title": "Футбол у кишені ваших фанів",
    "football-description":
      "Ваші фани зможуть з легкістю відстежувати всі новини, ігри та оновлення своєї улюбленої команди, завдяки нашому додатку, який забезпечує постійний зв'язок з командою.",
    ...
    "review-1":
      "Pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. We use Connect for key for easy and seamless weekly communication with our clients and .",
    "review-2":
      "Pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. We use Connect for key for easy and seamless weekly communication with our clients and .",
    "review-3":
      "We use Connect for key for easy and seamless weekly communication with our clients. Pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid.",
  ...
  ua: {
    ...
    "manage-title": "Зручне управління контентом",
    "manage-description":
      "Використовуйте нашу мобільно-оптимізовану панель адміністрації для легкого та ефективного управління контентом прямо з вашого телефону. Керуйте розкладом матчів, новинами та інформацією про гравців з комфортом.",
    ...
    "events-title": "Події в реальному часі",
    "events-description":
      "Отримуйте найсвіжішу інформацію одразу, як вона стає доступною. Розклади матчів, огляди матчів, прямі трансляції та детальний аналіз подій - все це відбувається в реальному часі.",

    "agree-title": "Дізнайтесь думку фанів",
    "agree-description":
      "Збирайте відгуки і відповіді ваших фанів, використовуючи анкети, опитування та голосування. Реагуйте на побажання своєї аудиторії, щоб підвищити її задоволеність та взаємодію.",

    "football-title": "Футбол у кишені ваших фанів",
    "football-description":
      " Ваші фани зможуть з легкістю відстежувати всі новини, ігри та оновлення своєї улюбленої команди, завдяки нашому додатку.",

    // features section

    data: "Обмін даними.",
    "data-description":
      "Коли ви прямо до суті, презентація виглядає привабливо на ваших веб-сторінках.",
    ...
    "review-description":
      "Коли ви переходите безпосередньо до суті, презентація виглядає привабливо.",
    "review-1":
      "Pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. We use Connect for key for easy and seamless weekly communication with our clients and .",
    "review-2":
      "Pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. We use Connect for key for easy and seamless weekly communication with our clients and .",
    ...
    "pricing-description":
      "Наші плани розроблені таким чином, щоб задовольнити вимоги як новачків, так і гравців. Оберіть правильний план, який вам підходить.",
    ...
    refund:
      "* Запити на повернення можна прийняти протягом 10 днів після покупки.",
    ...
    "contact-title":
      "Connect створено спеціально для вас. Готові створити свій наступний проект?",
