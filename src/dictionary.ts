export const dictionary = {
  en: {
    ...
    "manage-title": "Зручна управління контентом",
    "manage-description":
    ...
    "agree-title": "Дізнайтесь думку фанатів",
    "agree-description":
      "Збирайте відгуки і відповіді ваших фанів, використовуючи анкети, опитування та голосування. Навчайтеся та реагуйте на побажання своєї аудиторії, щоб підвищити її задоволеність та взаємодію.",
